                ...
                <div class="w-full max-w-xs bg-white border border-gray-200 rounded-2xl shadow-lg dark:bg-gray-800 dark:border-gray-700 transition hover:scale-105 hover:shadow-xl duration-200">
                    ...
                    <div class="p-4">
                        ...
                        <div class="flex justify-between items-center mt-4">
                            <a href="{{ route('cart.add', ['id' => $produkt->idprodukt]) }}" class="text-white bg-green-600 hover:bg-green-700 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-green-500 dark:hover:bg-green-600 dark:focus:ring-green-800">
                                Koupit
                            </a>
